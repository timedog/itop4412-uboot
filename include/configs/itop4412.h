...
/* ITOP4412 has 4 bank of DRAM(1GB) */
...
/* MACH_TYPE generated from arch/arm/tools/mach-types,
   here we define by self */
...
/*
	...
	0 secotr
	+----------+----------------+-------------------+-----+-------+
	| 512Byte  |       BL1      |   BL2(spl-uboot)  | ENV | uboot |
	+----------+----------------+-------------------+-----+-------+
*/
#define CONFIG_SYS_MMC_ENV_DEV		0
#define CONFIG_ENV_SIZE			(8 << 10)	/* 8 KB */
#define RESERVE_BLOCK_SIZE		(512)
#define BL1_SIZE				(8 << 10)   /* 8 KB */
#define BL2_SIZE				(16 << 10)  /* 16 KB */
