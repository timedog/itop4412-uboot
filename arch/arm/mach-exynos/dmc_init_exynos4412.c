...
__maybe_unused static void phy_control_reset(int ctrl_no, struct exynos4_dmc *dmc)
{
	if (ctrl_no) {
...
__maybe_unused static void dmc_config_mrs(struct exynos4_dmc *dmc, int chip)
{
	int i;
